...
@Entity
@SequenceGenerator(initialValue = 1, name = "idgen", sequenceName = "account_seq")
...
@Entity
@SequenceGenerator(initialValue = 1, name = "idgen", sequenceName = "category_seq")
...
@Entity
@SequenceGenerator(initialValue = 1, name = "idgen", sequenceName = "currency_seq")
data class Currency @JsonCreator constructor(@Column(name = "currency_name") var currencyName: String?)
    : AbstractJpaEntity<Long>(), Serializable

@Entity
@SequenceGenerator(initialValue = 1, name = "idgen", sequenceName = "transaction_seq")
...
@Entity(name = "usr")
@SequenceGenerator(initialValue = 1, name = "idgen", sequenceName = "usr_seq")
